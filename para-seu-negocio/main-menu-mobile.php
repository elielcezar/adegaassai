<div id="main-menu-mobile-2">
    <ul id="menu-menu-principal-2" class="menu">
      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-188"><a href="<?php echo site_url(); ?>/selecao-assai/"><span>Seleção Assaí</span></a></li>
      ...
      <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-193"><a href="<?php echo site_url(); ?>/category/dicas/"><span>Dicas de Sommelier</span></a></li>
    </ul>
  </div>