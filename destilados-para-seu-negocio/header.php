...
<body <?php body_class(); ?>>
  ...
  <div class="menu-mobile">
    <nav class="mainMenu">
      <ul class="menu">
        <li>
          <a href="https://megamidiagroup.com.br/adegaassai/destilados-para-voce/" id="para-voce">Para <strong>Você</strong></a>
        </li>
        <li>
          <a href="<?php echo site_url(); ?>" id="para-negocio"  class="active">Para <strong>seu negócio</strong></a>
        </li>
      </ul>
  ...
  <header>
    <div class="container">
        ...
        <nav class="left">
            <ul class="select">
              <li><a href="https://megamidiagroup.com.br/adegaassai/destilados-para-voce/" class="para-voce">Home <strong>Para Você</strong></a></li>
              <li><a href="<?php echo site_url(); ?>/" class="para-negocio active">Home <strong>Para Seu Negócio</strong></a></li>
            </ul>
