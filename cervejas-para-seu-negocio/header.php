...
<body <?php body_class(); ?>>
  ...
  <div class="menu-mobile">
    <nav class="mainMenu">
      <ul class="menu">
        <li>
          <a href="https://megamidiagroup.com.br/adegaassai/cervejas-para-voce/" id="para-voce">Para <strong>Você</strong></a>
        </li>
        <li>
  ...
  <header>
    <div class="container">
        ...
        <nav class="left">
            <ul class="select">
              <li><a href="https://megamidiagroup.com.br/adegaassai/cervejas-para-voce/" class="para-voce">Home <strong>Para Você</strong></a></li>
